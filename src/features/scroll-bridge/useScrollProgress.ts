 ...
 * `useSceneEnabled` (WebGL и prefers-reduced-motion по спеке §7; проверка по
 * классу видеокарты убрана в фазе 1.5, см. `sceneSupport.ts`), — а здесь
 * приходит готовым ответом: дублировать эти проверки нельзя, они
 * разъезжаются.
 *
